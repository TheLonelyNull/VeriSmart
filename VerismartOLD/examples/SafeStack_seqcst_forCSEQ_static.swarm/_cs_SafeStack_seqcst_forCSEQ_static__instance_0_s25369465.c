 ...
 * 
 *  instance version    {"main": [[3, 3]], "thread_1": [[108, 108]], "thread_0": [[92, 92]], "thread_2": [[62, 62]]}
 *
 *  2021-02-24 16:07:03
 *
 *  params:
 *    -i examples/SafeStack_seqcst_forCSEQ_static.c, --rounds 4, --backend cbmc, --error-label ERROR, --unwind 4, --robin , -C examples/SafeStack_seqcst_forCSEQ_static_auto_config.json.tmp, -Z /home/marcocalenda/Documenti/VerismartOLD/examples/SafeStack_seqcst_forCSEQ_static.swarm/swarm_instances.list, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[2] __cs_thread_lines[4] = {2, 2, 2, 2};
