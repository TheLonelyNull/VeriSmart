 ...
 * 
 *  instance version    {"main": [[8, 8]], "thread_1": [[161, 161]], "thread_0": [[158, 158]], "thread_3": [[219, 219]], "thread_2": [[231, 231]]}
 *
 *  2021-02-24 15:40:42
 *
 *  params:
 *    -i examples/SafeStack_seqcst_forCSEQ_static.c, --rounds 4, --backend cbmc, --error-label ERROR, --unwind 4, --robin , -C prova.json.tmp, -Z /home/marcocalenda/Documenti/VerismartOLD/examples/SafeStack_seqcst_forCSEQ_static.swarm/swarm_instances.list, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[2] __cs_pc[4];
                                        unsigned __CPROVER_bitvector[3] __cs_pc_cs[4];
                                        unsigned __CPROVER_bitvector[2] __cs_last_thread;
                                        unsigned __CPROVER_bitvector[2] __cs_thread_lines[4] = {1, 2, 2, 2};
...
/* round  3 */
/* main */
                                        unsigned __CPROVER_bitvector[1] __cs_tmp_t0_r3;
                                        if (__cs_active_thread[0])
                                                {
...
/* thread_2 */
                                        ...
                                        unsigned __CPROVER_bitvector[1] __cs_tmp_t0_r4;
