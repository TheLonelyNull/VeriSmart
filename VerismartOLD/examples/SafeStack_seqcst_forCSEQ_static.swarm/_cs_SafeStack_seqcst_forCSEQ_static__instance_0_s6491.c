 ...
 * 
 *  instance version    {"main": [[1, 8]], "thread_1": [[1, 14], [43, 56], [71, 84], [85, 98]], "thread_0": [[1, 14], [57, 70], [85, 98], [113, 126]], "thread_2": [[57, 70], [71, 84], [85, 98], [127, 140]]}
 *
 *  2021-02-25 14:37:31
 *
 *  params:
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[6] __cs_thread_lines[4] = {8, 57, 57, 57};
