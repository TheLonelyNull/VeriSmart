 ...
 * 
 *  instance version    {"thread2_0": [[3, 3]], "main": [[1, 1]], "thread1_0": [[1, 3]], "thread3_0": [[11, 11]]}
 *
 *  2021-02-10 11:39:38
 *
 *  params:
 *    -i examples/sample_doWhile.c, --rounds 1, --backend cbmc, --error-label ERROR, --unwind 1, --robin , -C examples/sample_doWhile_auto_config.json.tmp, -Z /mnt/h/Desktop/verismart_first/examples/sample_doWhile.swarm/swarm_instances.list, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[2] __cs_thread_lines[4] = {2, 3, 2, 2};
...
IF(2,0,tthread2_0_1)
                                        __cs_local_thread2_x = nondet_int();
                                        __cs_mutex_lock(&m, 2);
                                        data += 2;
...
IF(3,0,tthread3_0_1)
                                        ...
                                        ;
                                        lab_before_thread3_0:
                                                __CPROVER_assume(__cs_pc_cs[3] >= 1);
                                        __cs_mutex_unlock(&m, 3);
                                        ;
                                                ;
                                        static int __cs_local_thread3___cs_dowhile_onetime_1;
                                        __cs_local_thread3___cs_dowhile_onetime_1 = 0;
                                                {
                                        data++;
                                        lab_inside_thread3_0_0:
                                                        __CPROVER_assume(__cs_pc_cs[3] >= 1);
                                        data--;
                                                }
                                        ;
                                        __cs_local_thread3___cs_dowhile_onetime_1++;
                                        __CPROVER_assume(!(__cs_local_thread3___cs_dowhile_onetime_1 < 1));
                                        __exit_loop_1:
                                                __CPROVER_assume(__cs_pc_cs[3] >= 1);
                                        ;
                                                ;
                                        ...
                                        ;
                                                ;
                                        static int __cs_local_thread3___cs_dowhile_onetime_2;
                                        __cs_local_thread3___cs_dowhile_onetime_2 = 0;
                                                {
                                        data--;
                                                }
                                        ;
                                        __cs_local_thread3___cs_dowhile_onetime_2++;
tthread3_0_1: IF(3,1,tthread3_0_2)
                                        __CPROVER_assume(!(__cs_local_thread3___cs_dowhile_onetime_2 < 1));
                                        __exit_loop_3:
