 ...
 * 
 *  instance version    {"thread2_0": [[1, 3]], "main": [[5, 5]], "thread1_0": [[1, 3]], "thread3_0": [[2, 2]]}
 *
 *  2021-02-05 18:41:20
 *
 *  params:
 *    -i examples/sample_funcInExp.c, --rounds 1, --backend cbmc, --error-label ERROR, --unwind 1, --robin , -C examples/sample_funcInExp_auto_config.json.tmp, -Z /mnt/h/Desktop/verismart_first/examples/sample_funcInExp.swarm/swarm_instances.list, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[2] __cs_thread_lines[4] = {2, 3, 3, 2};
...
tthread2_0_3: 
                                        ...
                                        {
                                        static int __cs_local_thread3_x;
IF(3,0,tthread3_0_1)
                                        __cs_local_thread3_x = nondet_int();
                                        __cs_mutex_lock(&m, 3);
                                        ;
                                                ;
...
tthread3_0_1: IF(3,1,tthread3_0_2)
                                        ...
                                        static int __cs_retval__foo_1;
                                                {
                                        static int __cs_param_foo_x;
                                        __cs_param_foo_x = __cs_local_thread3_x;
                                        __cs_retval__foo_1 = __cs_param_foo_x + 1;
                                        goto __exit__foo_1;
                                                        ;
                                        __exit__foo_1:
                                        ...
                                        ;
                                        __cs_local_thread3_x = 5 + __cs_retval__foo_1;
                                        __exit_thread3:
                                                __CPROVER_assume(__cs_pc_cs[3] >= 2);
                                        ;
                                                ;
