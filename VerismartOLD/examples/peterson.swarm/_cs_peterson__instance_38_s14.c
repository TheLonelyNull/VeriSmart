 ...
 * 
 *  instance version    {"main": [[1, 1]], "thr2_0": [[5, 6]], "thr1_0": [[5, 5]]}
 *
 *  2021-02-08 15:53:36
 *
 *  params:
 *    -i examples/peterson.c, --rounds 1, --backend cbmc, --error-label ERROR, --unwind 1, --robin , -C examples/peterson_auto_config.json, -Z /mnt/h/Desktop/verismart_first/examples/peterson.swarm/swarm_instances.list, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[2] __cs_thread_lines[3] = {2, 2, 3};
