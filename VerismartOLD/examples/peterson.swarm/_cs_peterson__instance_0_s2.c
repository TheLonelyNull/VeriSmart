 ...
 * 
 *  instance version    {"main": [[1, 4]], "thr2_0": [[4, 6], [7, 8]], "thr1_0": [[1, 6]]}
 *
 *  2021-02-16 19:41:31
 *
 *  params:
 *    -i examples/peterson.c, --rounds 1, --backend cbmc, --error-label ERROR, --unwind 1, --robin , -C examples/peterson_auto_config.json.tmp, -Z /home/marcocalenda/Documenti/VerismartOLD/examples/peterson.swarm/swarm_instances.list, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[3] __cs_thread_lines[3] = {4, 6, 5};
