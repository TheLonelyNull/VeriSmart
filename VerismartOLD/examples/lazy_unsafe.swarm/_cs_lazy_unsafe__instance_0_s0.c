 ...
 * 
 *  instance version    {"thread2_0": [[1, 3]], "main": [[1, 1], [2, 2]], "thread1_0": [[1, 3]], "thread3_0": [[1, 3]]}
 *
 *  2021-02-24 13:25:11
 *
 *  params:
 *    -i examples/lazy_unsafe.c, --rounds 1, --backend cbmc, --error-label ERROR, --unwind 1, --robin , -C examples/lazy_unsafe_auto_config.json.tmp, -Z /home/marcocalenda/Documenti/VerismartOLD/examples/lazy_unsafe.swarm/swarm_instances.list, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[2] __cs_thread_lines[4] = {3, 3, 3, 3};
