 ...
 * 
 *  instance version    {"thread1_0": [[1, 3]], "thread2_0": [[1, 3]], "thread3_0": [[1, 3]], "main": [[1, 1], [3, 3]]}
 *
 *  2021-02-24 13:24:25
 *
 *  params:
 *    --vs , -i examples/lazy_unsafe.c, -p 2, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[3] __cs_thread_lines[4] = {3, 3, 3, 2};
